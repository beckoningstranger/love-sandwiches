...
def get_sales_data():
    ...
    while True:
        ...
        print("Data should be sex numbers, seperated by commas.")
...
def update_worksheet(sheet_name, data):
    """
    Update given worksheet, add new row with the data provided.
    """
    print(f"Updating {sheet_name} worksheet...\n")
    worksheet = SHEET.worksheet(sheet_name)
    worksheet.append_row(data)
    print(f"{sheet_name.title()} worksheet updated successfully.\n")
